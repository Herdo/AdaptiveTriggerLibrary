namespace AdaptiveTriggerLibrary.Triggers.AwarenessTriggers
{
    ...
    /// <summary>
    /// This trigger activates, if the current latitude
    /// matches the specified <see cref="AdaptiveTriggerBase{TCondition,TConditionModifier}.Condition"/>.
    /// </summary>
    public class LatitudeTrigger : AdaptiveTriggerBase<double?, IComparableModifier>,
        IDynamicTrigger
    {
        ///////////////////////////////////////////////////////////////////
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LatitudeTrigger"/> class.
        /// Default modifier: <see cref="GreaterThanEqualToModifier"/>.
        /// </summary>
        public LatitudeTrigger()
